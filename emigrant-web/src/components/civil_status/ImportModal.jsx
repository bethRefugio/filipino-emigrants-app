  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4 text-xs">
            <strong>Required columns:</strong> year,single,married,widower,separated,divorced,notReported
            <br />
            <span className="text-blue-600">Example: 2024,15000,28000,1200,850,920,450</span>
        </div>
        {csvPreview.length > 0 && (
            <div className="mb-4">
