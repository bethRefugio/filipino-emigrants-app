...
import { addEmigrant } from './services/education'; // updated service name
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          if (values.length >= headers.length) {
            const record = {
              ...
              vocationalLevel: Number(values[headers.indexOf('vocationallevel')]) || 0,
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Upload Education CSV Data</h1>
              <p className="text-sm text-gray-500">Import education attainment data from a CSV file</p>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <code className="block bg-white p-3 rounded text-xs text-gray-800 overflow-x-auto">
              year,notOfSchoolingAge,noFormalEducation,elementaryLevel,elementaryGraduate,highSchoolLevel,highSchoolGraduate,vocationalLevel,vocationalGraduate,collegeLevel,collegeGraduate,postGraduateLevel,postGraduate,nonFormalEducation,notReported
            </code>
          </div>
...
2024,500,300,1200,1800,1500,2000,800,900,2200,2500,300,400,150,100
2023,480,310,1150,1750,1400,1900,780,880,2100,2400,290,380,140,120
2022,460,290,1100,1700,1300,1850,750,850,2000,2300,270,350,130,110`;
