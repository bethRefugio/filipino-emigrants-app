        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          if (values.length >= headers.length) {
            const record = {
              ...
              single: Number(values[headers.indexOf('single')]) || 0,
              married: Number(values[headers.indexOf('married')]) || 0,
              widower: Number(values[headers.indexOf('widower')]) || 0,
              separated: Number(values[headers.indexOf('separated')]) || 0,
              divorced: Number(values[headers.indexOf('divorced')]) || 0,
              notReported: Number(values[headers.indexOf('notreported')] || values[headers.indexOf('not reported')]) || 0,
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            ...
            <code className="block bg-white p-3 rounded text-xs text-gray-800 overflow-x-auto">
              year,single,married,widower,separated,divorced,notReported,country
            </code>
            <p className="text-xs text-blue-600 mt-2">
              Example: 2024,15000,28000,1200,850,920,450,USA
            </p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t">
            ...
            <button
              onClick={() => {
                const sampleCSV = `year,single,married,widower,separated,divorced,notReported,country
2024,15000,28000,1200,850,920,450,USA
2023,14500,27500,1150,820,900,480,Canada`;
