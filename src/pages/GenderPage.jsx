...
import TopNavbar from '../components/gender/TopNavbar';
import KpiCards from '../components/gender/KpiCards';
import GenderTable from '../components/gender/GenderTable';
import AddModal from '../components/AddModal';
import EditModal from '../components/EditModal';
import ImportModal from '../components/gender/ImportModal';
import Visualizations from '../components/gender/Visualizations';
import { getEmigrants, addEmigrant, updateEmigrant, deleteEmigrant } from '../services/gender';
...
export default function GenderPage() {
  ...
  const [selectedCategories, setSelectedCategories] = useState([...genderCategories]);
  ...
  const handleExportCSV = () => {
    ...
    a.href = url;
    a.download = 'filipino_emigrants_gender_data.csv';
    a.click();
